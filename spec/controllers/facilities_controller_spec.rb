...
# rspec spec/controllers/facilities_controller_spec.rb
# zeus test spec/controllers/facilities_controller_spec.rb
    ...
    context 'valid session' do
      context 'when params[:cmd] == get' do
        it 'get facilities' do
          ...
          expect(parsed_body['facilities']).to_not be nil
        end
      end
