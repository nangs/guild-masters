...
#rspec spec/controllers/adventurers_controller_spec.rb
#zeus test spec/controllers/adventurers_controller_spec.rb

RSpec.describe AdventurersController do
  before :each do
    ...
    context "valid session" do
      context "when params[:cmd] == get" do
        it "get adventurers" do
          ...
          expect(parsed_body["adventurers"]).to_not be nil
        end
      end
